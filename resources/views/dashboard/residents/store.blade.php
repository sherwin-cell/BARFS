    ...
    <nav class="sidebar">
        ...
        <div class="links residents-links">
            <a href="{{ route('dashboard.residents.index') }}"
                class="nav-item {{ request()->routeIs('dashboard.residents.index') ? 'active' : '' }}">List Residents</a>

            <a href="{{ route('dashboard.residents.create') }}"
                class="nav-item {{ request()->routeIs('dashboard.residents.create') ? 'active' : '' }}">Add Resident</a>
        </div>
